...
export default function Order() {
    ...
    return (
        <div>
        <div className="h-full py-65 bg-gray-100 mx-3 md:mx-16 lg:mx-32  my-20 rounded-lg shadow-xl">
            <div className="mx-2 md:mx-24 text-center py-20">
                <span className="text-4xl  text-gray-800 block pb-8">ORDER NOW</span>
                <form>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                    <label class="block text-gray-800  md:text-right mb-1 md:mb-0 pr-4" for="inline-full-name">
                        Item
                    </label>
                    </div>
                    <div class="md:w-2/3">
                    ...
                    focus:bg-white focus:border-purple-500" id="inline-full-Item" 
